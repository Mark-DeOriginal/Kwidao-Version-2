        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-[#c1c0bc] mb-8 leading-relaxed">
              Connect with thousands of DeFi enthusiasts, earn points by
              participating, and shape the future of Kwidao through governance.
            </p>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-center gap-4 p-4 rounded-lg border border-[#fff2b0]/10 bg-[#363523]/50">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#c1c0bc]">
                    Latest updates, market insights, and announcements
                  </p>
                </div>
                <Link
                  href="https://twitter.com"
                  target="_blank"
                  className="ml-auto text-[#fff2b0] hover:text-[#fff2b0]/80"
                >
                  <svg
                    className="w-6 h-6"
                    fill="currentColor"
              ...
              <div className="flex items-center gap-4 p-4 rounded-lg border border-[#fff2b0]/10 bg-[#363523]/50">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#c1c0bc]">
                    Chat, support, and community events
                  </p>
                </div>
                <Link
              ...
              <div className="flex items-center gap-4 p-4 rounded-lg border border-[#fff2b0]/10 bg-[#363523]/50">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#c1c0bc]">
                    Real-time notifications and community
                  </p>
                </div>
                <Link
            ...
            <p className="text-sm text-[#c1c0bc] bg-[#363523]/50 border border-[#fff2b0]/10 rounded-lg p-4">
              <strong>Earn Points:</strong> Participate in governance, refer
              friends, and engage with the community to accumulate points toward
              future rewards and airdrop eligibility.
            </p>
          </motion.div>
