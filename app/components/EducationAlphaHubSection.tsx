  ...
  const articles = [
    {
      ...
      description: 'A comprehensive guide for beginners on understanding yield farming, risks, and best practices.',
      date: 'Feb 10, 2025',
      category: 'Education',
    },
    {
      title: 'Market Alert: Current Opportunities in Avalanche Ecosystem',
      description: 'Analysis of the latest high-yield farming opportunities with risk assessments.',
      date: 'Feb 9, 2025',
      category: 'Market Insights',
    },
    {
      title: 'Smart Contract Security: Protecting Your Assets',
      description: 'What to look for in audit reports and how to evaluate protocol safety.',
      date: 'Feb 8, 2025',
      category: 'Security',
    },
  ];
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
              ...
              {articles.map((article, i) => (
                ...
                >
                  <div className="flex items-start justify-between mb-2">
                    <h4 className="text-sm font-bold text-[#fff2b0] flex-grow">{article.title}</h4>
                    <span className="text-xs font-semibold text-[#fff2b0]/60 ml-2 whitespace-nowrap">
                      {article.category}
                    </span>
                  </div>
                  <p className="text-xs text-[#c1c0bc] leading-relaxed mb-3">{article.description}</p>
          ...
          >
            ...
            <p className="text-[#c1c0bc] mb-6">
              Weekly strategies, risk alerts, and opportunities delivered to your inbox.
            </p>
            ...
            <div className="mt-6 pt-6 border-t border-[#fff2b0]/10">
              ...
              <div className="space-y-2">
                {['Market Analysis', 'Yield Opportunities', 'Security Tips', 'Airdrop Updates'].map((topic, i) => (
                  <div key={i} className="flex items-center gap-2 text-sm text-[#c1c0bc]">
